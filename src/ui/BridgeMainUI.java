...
public class BridgeMainUI {
	...
	private void initialize() {
		...
		Button btn_choose_local = new Button("\u221A");
		btn_choose_local.setBounds(101, 103, 31, 23);
		...
		txt_area_log.setBounds(10, 332, 815, 170);
		...
		btn_del_json.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (cbx_action.getState()) {
					mAdbManager.runCommand("adb shell rm -r /sdcard/tencent/MobileQQ/.apollo/action/action_v655.json");
				}
